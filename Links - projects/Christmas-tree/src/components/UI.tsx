    ...
    return (
        <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-6 z-10">
            ...
            <div className="absolute top-6 right-6 pointer-events-auto z-20">
                <a 
                    href="../../../links.html"
                    className="px-4 py-2 bg-[#FFD700]/80 hover:bg-[#FFD700] text-[#1a1a1a] font-semibold rounded-lg shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105 backdrop-blur-sm border border-[#FFD700]/50"
